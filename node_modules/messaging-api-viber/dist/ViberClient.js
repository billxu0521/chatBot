...
function pascalcaseKeysDeep(input) {
    if (Array.isArray(input)) {
        return input.map(item => pascalcaseKeysDeep(item));
    }
    if (input && typeof input === 'object') {
        return map_obj_1.default(input, (key, val) => {
            return [pascal_case_1.default(key), pascalcaseKeysDeep(val)];
        });
    }
    return input;
}
function transformMessageCase(message) {
    ...
    return Object.assign(Object.assign(Object.assign({}, snakecase_keys_1.default(others, { deep: true })), (keyboard ? { keyboard: pascalcaseKeysDeep(keyboard) } : undefined)), (richMedia
        ? {
...
class ViberClient {
    ...
    _callAPI(path, body = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(snakecase_keys_1.default(body, { deep: false }));
                ...
                snakecase_keys_1.default(body, { deep: false }));
