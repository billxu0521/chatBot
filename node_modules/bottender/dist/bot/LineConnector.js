...
const LineContext_1 = __importDefault(require("../context/LineContext"));
const LineEvent_1 = __importDefault(require("../context/LineEvent"));
class LineConnector {
    constructor(options) {
        const { mapDestinationToAccessToken, shouldBatch, sendMethod, skipProfile, } = options;
