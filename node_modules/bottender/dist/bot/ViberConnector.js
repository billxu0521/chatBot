...
const ViberContext_1 = __importDefault(require("../context/ViberContext"));
const ViberEvent_1 = __importDefault(require("../context/ViberEvent"));
class ViberConnector {
    ...
    updateSession(session, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Object.keys(deep_object_diff_1.addedDiff(session.user || {}, user)).length > 0) {
