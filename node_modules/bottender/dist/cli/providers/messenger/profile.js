        ...
        try {
            ...
            if (force) {
                ...
                if (_profile.whitelisted_domains) {
                    yield client.setMessengerProfile(lodash_1.pick(_profile, 'whitelisted_domains'));
                    yield client.setMessengerProfile(lodash_1.omit(_profile, 'whitelisted_domains'));
                }
                else {
                ...
                if (Object.keys(diffResult).length !== 0) {
                    ...
                    if (shouldDeleteFields.length > 0) {
                        yield client.deleteMessengerProfile(shouldDeleteFields);
                    ...
                    if (shouldSetFields.length > 0) {
                        ...
                        if (shouldSetFields.includes('whitelisted_domains')) {
                            yield client.setMessengerProfile(lodash_1.pick(shouldSetProfile, 'whitelisted_domains'));
                            yield client.setMessengerProfile(lodash_1.omit(shouldSetProfile, 'whitelisted_domains'));
                        }
                        else {
