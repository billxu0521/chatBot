...
const LineBot_1 = __importDefault(require("./bot/LineBot"));
const MessengerBot_1 = __importDefault(require("./bot/MessengerBot"));
const SlackBot_1 = __importDefault(require("./bot/SlackBot"));
const TelegramBot_1 = __importDefault(require("./bot/TelegramBot"));
const ViberBot_1 = __importDefault(require("./bot/ViberBot"));
