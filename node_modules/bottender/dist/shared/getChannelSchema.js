...
const menuItemSchema = joi_1.default.object().keys({
    ...
    webview_height_ratio: joi_1.default.string(),
    messenger_extensions: joi_1.default.boolean(),
    fallback_url: joi_1.default.string(),
    webview_share_button: joi_1.default.string(),
});
const messengerSchema = joi_1.default.object().keys({
    ...
    profile: joi_1.default.object().keys({
        get_started: joi_1.default.object().keys({
            payload: joi_1.default.string(),
        }),
        persistent_menu: joi_1.default.array().items(joi_1.default.object().keys({
            locale: joi_1.default.string(),
            composer_input_disabled: joi_1.default.boolean(),
            call_to_actions: joi_1.default.array()
        ...
        whitelisted_domains: joi_1.default.array().items(joi_1.default.string()),
    }),
});
