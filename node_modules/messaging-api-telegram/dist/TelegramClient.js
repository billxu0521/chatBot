...
class TelegramClient {
    ...
    _request(path, body = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this._axios.post(path, snakecase_keys_1.default(body));
                ...
                if (isObject_1.default(data.result)) {
                    return camelcase_keys_1.default(data.result, { deep: true });
                }
                return data.result;
            }
            catch (err) {
    ...
    _optionWithoutKeys(option, revmoeKeys) {
        let keys = Object.keys(option);
        keys = difference_1.default(keys, revmoeKeys);
        keys = difference_1.default(keys, revmoeKeys.map(key => to_snake_case_1.default(key)));
