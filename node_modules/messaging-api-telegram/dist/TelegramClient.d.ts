...
export default class TelegramClient {
     ...
     */
    setWebhook(url: string, options?: Type.SetWebhookOption): Promise<boolean>;
    /**
     ...
     */
    sendMessage(chatId: string | number, text: string, options?: Type.SendMessageOption): Promise<Type.Message>;
    /**
     ...
     */
    forwardMessage(chatId: string | number, fromChatId: string | number, messageId: number, options?: Type.ForwardMessageOption): Promise<Type.Message>;
    /**
     ...
     */
    sendPhoto(chatId: string | number, photo: string, options?: Type.SendPhotoOption): Promise<Type.Message>;
    /**
     ...
     */
    sendAudio(chatId: string | number, audio: string, options?: Type.SendAudioOption): Promise<Type.Message>;
    /**
     ...
     */
    sendDocument(chatId: string | number, document: string, options?: Type.SendDocumentOption): Promise<Type.Message>;
    /**
     ...
     */
    sendVideo(chatId: string | number, video: string, options?: Type.SendVideoOption): Promise<Type.Message>;
    /**
     ...
     */
    sendAnimation(chatId: string | number, animation: string, options?: Type.SendAnimationOption): Promise<Type.Message>;
    /**
     ...
     */
    sendVoice(chatId: string | number, voice: string, options?: Type.SendVoiceOption): Promise<Type.Message>;
    /**
     ...
     */
    sendVideoNote(chatId: string | number, videoNote: string, options?: Type.SendVideoNoteOption): Promise<Type.Message>;
    /**
     ...
     */
    sendMediaGroup(chatId: string | number, media: (Type.InputMediaPhoto | Type.InputMediaVideo)[], options?: Type.SendMediaGroupOption): Promise<Type.Message[]>;
    /**
    ...
    sendLocation(chatId: string | number, { latitude, longitude }: {
        latitude: number;
        longitude: number;
    }, options?: Type.SendLocationOption): Promise<Type.Message>;
    /**
    ...
    editMessageLiveLocation({ latitude, longitude }: {
        latitude: number;
        longitude: number;
    }, options: Type.EditMessageLiveLocationOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    stopMessageLiveLocation(options: Type.StopMessageLiveLocationOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    sendVenue(chatId: string | number, venue: Type.Venue, options?: Type.SendVenueOption): Promise<Type.Message>;
    /**
     ...
     */
    sendContact(chatId: string | number, requiredOptions: Type.SendContactRequiredOption, options?: Type.SendContactOption): Promise<Type.Message>;
    /**
     ...
     */
    sendPoll(chatId: string | number, question: string, options: string[], otherOptions?: Type.SendPollOption): Promise<Type.Message>;
    /**
     ...
     */
    sendChatAction(chatId: string | number, action: Type.ChatAction): Promise<boolean>;
    /**
     ...
     */
    getUserProfilePhotos(userId: number, options?: Type.GetUserProfilePhotosOption): Promise<Type.UserProfilePhotos>;
    /**
     ...
     */
    kickChatMember(chatId: string | number, userId: number, options?: Type.KickChatMemberOption): Promise<boolean>;
    /**
     ...
     */
    restrictChatMember(chatId: string | number, userId: number, permissions: Type.ChatPermissions, options?: Type.RestrictChatMemberOption): Promise<boolean>;
    /**
     ...
     */
    promoteChatMember(chatId: string | number, userId: number, options?: Type.PromoteChatMemberOption): Promise<boolean>;
    /**
     ...
     */
    setChatPermissions(chatId: string | number, permissions: Type.ChatPermissions): Promise<boolean>;
    /**
     ...
     */
    pinChatMessage(chatId: string | number, messageId: number, options?: Type.PinChatMessageOption): Promise<boolean>;
    /**
     ...
     */
    getChatMember(chatId: string | number, userId: number): Promise<Type.ChatMember>;
    /**
     ...
     */
    answerCallbackQuery(callbackQueryId: string, options: Type.AnswerCallbackQueryOption): Promise<boolean>;
    /**
     ...
     */
    editMessageText(text: string, options?: Type.EditMessageTextOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    editMessageCaption(caption: string, options?: Type.EditMessageCaptionOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    editMessageMedia(media: Type.InputMedia, options: Type.EditMessageMediaOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    editMessageReplyMarkup(replyMarkup: Type.InlineKeyboardMarkup, options?: Type.EditMessageReplyMarkupOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    stopPoll(chatId: string | number, messageId: number, options?: Type.StopPollOption): Promise<Type.Poll>;
    /**
     ...
     */
    sendSticker(chatId: string | number, sticker: string, options?: Type.SendStickerOption): Promise<Type.Message>;
    /**
     ...
     */
    createNewStickerSet(userId: number, name: string, title: string, pngSticker: string, emojis: string, options?: Type.CreateNewStickerSetOption): Promise<boolean>;
    /**
     ...
     */
    addStickerToSet(userId: number, name: string, pngSticker: string, emojis: string, options?: Type.AddStickerToSetOption): Promise<boolean>;
    /**
     ...
     */
    answerInlineQuery(inlineQueryId: string, results: Type.InlineQueryResult[], options?: Type.AnswerInlineQueryOption): Promise<boolean>;
    /**
     ...
     */
    sendInvoice(chatId: number, product: Type.Product, options?: Type.SendInvoiceOption): Promise<Type.Message>;
    /**
     ...
     */
    answerShippingQuery(shippingQueryId: string, ok: boolean, options?: Type.AnswerShippingQueryOption): Promise<boolean>;
    /**
     ...
     */
    answerPreCheckoutQuery(preCheckoutQueryId: string, ok: boolean, options?: Type.AnswerPreCheckoutQueryOption): Promise<boolean>;
    /**
     ...
     */
    sendGame(chatId: number, gameShortName: string, options?: Type.SendGameOption): Promise<Type.Message>;
    /**
     ...
     */
    setGameScore(userId: number, score: number, options?: Type.SetGameScoreOption): Promise<Type.Message | boolean>;
    /**
     ...
     */
    getGameHighScores(userId: number, options?: Type.GetGameHighScoresOption): Promise<Type.GameHighScore[]>;
}
export {};
