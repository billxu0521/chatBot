...
class LineClient {
    ...
    replyRawBody(body, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post('/v2/bot/message/reply', body, customAccessToken === undefined
            ? undefined
            : {
    ...
    pushRawBody(body, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post('/v2/bot/message/push', body, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    multicastRawBody(body, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post('/v2/bot/message/multicast', body, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
     ...
     */
    retrieveMessageContent(messageId, { accessToken: customAccessToken } = {}) {
        return this._axios
    ...
    getUserProfile(userId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/profile/${userId}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getGroupMemberProfile(groupId, userId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/group/${groupId}/member/${userId}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getRoomMemberProfile(roomId, userId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/room/${roomId}/member/${userId}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getGroupMemberIds(groupId, start, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/group/${groupId}/members/ids${start ? `?start=${start}` : ''}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getRoomMemberIds(roomId, start, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/room/${roomId}/members/ids${start ? `?start=${start}` : ''}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    leaveGroup(groupId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post(`/v2/bot/group/${groupId}/leave`, null, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    leaveRoom(roomId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post(`/v2/bot/room/${roomId}/leave`, null, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getRichMenuList({ accessToken: customAccessToken, } = {}) {
        return this._axios
            .get('/v2/bot/richmenu/list', customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getRichMenu(richMenuId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/richmenu/${richMenuId}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    createRichMenu(richMenu, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post('/v2/bot/richmenu', richMenu, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    deleteRichMenu(richMenuId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .delete(`/v2/bot/richmenu/${richMenuId}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getLinkedRichMenu(userId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .get(`/v2/bot/user/${userId}/richmenu`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    linkRichMenu(userId, richMenuId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post(`/v2/bot/user/${userId}/richmenu/${richMenuId}`, null, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    unlinkRichMenu(userId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .delete(`/v2/bot/user/${userId}/richmenu`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getDefaultRichMenu({ accessToken: customAccessToken, } = {}) {
        return this._axios
            .get(`/v2/bot/user/all/richmenu`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    setDefaultRichMenu(richMenuId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post(`/v2/bot/user/all/richmenu/${richMenuId}`, null, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    deleteDefaultRichMenu({ accessToken: customAccessToken, } = {}) {
        return this._axios
            .delete(`/v2/bot/user/all/richmenu`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    issueLinkToken(userId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post(`/v2/bot/user/${userId}/linkToken`, null, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    getLiffAppList({ accessToken: customAccessToken, } = {}) {
        return this._axios
            .get('/liff/v1/apps', customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    createLiffApp(view, { accessToken: customAccessToken } = {}) {
        return this._axios
            .post('/liff/v1/apps', view, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    updateLiffApp(liffId, view, { accessToken: customAccessToken } = {}) {
        return this._axios
            .put(`/liff/v1/apps/${liffId}/view`, view, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
    ...
    deleteLiffApp(liffId, { accessToken: customAccessToken } = {}) {
        return this._axios
            .delete(`/liff/v1/apps/${liffId}`, customAccessToken === undefined
            ? undefined
            : {
                headers: { Authorization: `Bearer ${customAccessToken}` },
            })
